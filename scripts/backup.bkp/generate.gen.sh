...
SHELL_UTILS_BKP_PATHS=${SHELL_UTILS_BKP_PATHS-"$HOME/.zshrc.private $HOME/.env $HOME/Documents $HOME/update.sh $HOME/.password-store $HOME/.config/shell-utils"}
SHELL_UTILS_BACKUP_ZIP_DIR=${SHELL_UTILS_BACKUP_ZIP_DIR:-/tmp}
